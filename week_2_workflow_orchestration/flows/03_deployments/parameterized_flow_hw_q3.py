...
def write_bq(df: pd.DataFrame) -> None:
    ...
    df.to_gbq(
        destination_table="dezoomcamp.hwq3_rides",
        project_id="stoked-duality-375907",
...
def etl_parent_flow(
    ...
    for month in months:
        ...
        df_total_count = df_total_count + df_file_count
    print(f"Log print: Number rows in all files : {df_total_count}")
